  ...
  const [active, setActive] = useState(1)
    ...
    useEffect(()=> {
        const getCategories = async() => {
            try {
                ...
                console.log("Looking for catalog name:", catalogName);
                
                const matchingCategory = res?.data?.data?.filter((ct) => 
    ...
    useEffect(() => {
        ...
        if(categoryId) {
            ...
            console.log("No categoryId available, skipping catalog data fetch");
        }
